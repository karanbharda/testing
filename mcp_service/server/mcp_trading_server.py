...
# Dummy Server class for MCP protocol compatibility
class Server:
    """Dummy MCP Server class for internal use"""
    ...
    async def run_stdio(self):
        """Context manager for stdio transport (dummy implementation)"""
        class StdioStreams:
...
class MCPTradingServer:
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        try:
            import psutil
            health_status["memory_usage_mb"] = psutil.Process().memory_info().rss / 1024 / 1024
            health_status["cpu_percent"] = psutil.Process().cpu_percent()
        except (ImportError, AttributeError):
            health_status["memory_usage_mb"] = None
            health_status["cpu_percent"] = None
